...
#ifndef LR_WPAN_CSMACA_RL_H
#define LR_WPAN_CSMACA_RL_H
 ...
 */
class LrWpanCsmaCaRl : public LrWpanCsmaCaCommon
{
  ...
  public:
     ...
     */
    LrWpanCsmaCaRl();
    LrWpanCsmaCaRl(uint8_t priority);
    ~LrWpanCsmaCaRl() override;

    // Delete copy constructor and assignment operator to avoid misuse
    LrWpanCsmaCaRl(const LrWpanCsmaCaRl&) = delete;
    LrWpanCsmaCaRl& operator=(const LrWpanCsmaCaRl&) = delete;
  ...
  private:
    ...
    */
    ...
    uint32_t m_previousBackoffCount;
    uint32_t m_backoff;
    /**
    ...
    */
    TracedCallback<uint8_t, uint32_t> m_csmaCaRlCollisionTrace;
    /**
    * The trace source fired when dynamic failure occurs.
    */
    TracedCallback<uint8_t> m_csmaCaRlMKViolationTrace;
    /**
     * transmission result queue.
     */
    std::deque<bool> m_resultQueue;
    /**
     * previously choosed action.
     */
    uint8_t m_action;
};
